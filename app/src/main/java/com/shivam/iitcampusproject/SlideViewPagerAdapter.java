    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        btnGetStarted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ctx,InToScreenActivity.class);
        ...
        switch (position)
        {
            case 0:
                ...
                title.setText("");
                desc.setText("The Way You Love , The Way We Serve ️");
            ...
            case 1:
                ...
                title.setText("");
                desc.setText("Shopping is Never a Bad IDEA ");
            ...
            case 2:
                ...
                title.setText("");
                desc.setText("Always Deliver More Than Expected");
                back.setVisibility(View.VISIBLE);
