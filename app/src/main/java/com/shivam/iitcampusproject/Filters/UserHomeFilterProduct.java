...
public class UserHomeFilterProduct extends Filter {

    private UserHomeShowProducts adapter;
    private ArrayList<Products> filterList;

    public UserHomeFilterProduct(UserHomeShowProducts adapter, ArrayList<Products> filterList) {
