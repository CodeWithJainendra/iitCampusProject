...
public class FilterProductBuyer extends Filter {
    ...
    private UserShowProducts adapter;
    private ArrayList<Products> filterList;

    public FilterProductBuyer(UserShowProducts adapter, ArrayList<Products> filterList) {
    ...
    protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
        adapter.productsList = (ArrayList<Products>) filterResults.values;
